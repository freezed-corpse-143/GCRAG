...
class ResidualCodec:
    ...
    def load(cls, index_path):
        ...
        avg_residual = torch.load(avgresidual_path, map_location='cpu', weights_only=True)
        bucket_cutoffs, bucket_weights = torch.load(buckets_path, map_location='cpu', weights_only=True)
